...
public class DBUtil {
    ...
    public static int insert(Connection connection, Object obj) throws Exception {
        ...
        stringBuffer.append(StringUtil.underscoreName(clazz.getSimpleName()) + " (");//获取表名
        ...
        for (int i = 0; i < fields.length; i++) {//得到字符长度
            ...
            stringBuffer.append(StringUtil.underscoreName(fieldName) + ",");//获取字符的名字并拼上","
        }
        stringBuffer.deleteCharAt(stringBuffer.length() - 1);
    ...
    public static <T> int delete(Connection connection, Serializable id, Class<T> c) throws Exception {
        ...
        stringBuffer.append(StringUtil.underscoreName(name));//获取表名
    ...
    public static int update(Connection connection, Object obj) throws Exception {
        ...
        stringBuffer.append(StringUtil.underscoreName(clazz.getSimpleName()) + " set ");//获取表名并拼上"set"
